...
if %errorlevel% EQU 0 set "CPUTDP=105"
echo %CPUNAME% | findstr /i "7800X3D 7900X3D 7950X3D" >nul
if %errorlevel% EQU 0 set "CPUTDP=120"
echo %CPUNAME% | findstr /i "Ryzen 9 79 Ryzen 9 39" >nul
if %errorlevel% EQU 0 set "CPUTDP=170"
echo %CPUNAME% | findstr /i "Ryzen 9" >nul
if %errorlevel% EQU 0 set "CPUTDP=105"
echo %CPUNAME% | findstr /i "Ryzen 7 58" >nul
if %errorlevel% EQU 0 set "CPUTDP=105"
echo %CPUNAME% | findstr /i "Ryzen 7 77" >nul
if %errorlevel% EQU 0 set "CPUTDP=105"
echo %CPUNAME% | findstr /i "Ryzen 7" >nul
if %errorlevel% EQU 0 set "CPUTDP=65"
echo %CPUNAME% | findstr /i "Ryzen 5" >nul
if %errorlevel% EQU 0 set "CPUTDP=65"
echo %CPUNAME% | findstr /i "i9" >nul
if %errorlevel% EQU 0 set "CPUTDP=253"
echo %CPUNAME% | findstr /i "i7 i5" >nul
if %errorlevel% EQU 0 set "CPUTDP=125"
...
:perfil_fim
echo === ESTIMATIVA: %PERFIL% (%PCT_ESC%% comercial / %PCT_JOG%% jogos) === >> "%LOG%"
...
set "PASTA_GANHO=2 a 5 C mais frio que stock"
...
:p_rise
set "PASTA_NOME=Rise Mode Cold 7.5"
set "PASTA_DUR=Baixa (3 meses a 1 ano)"
set "PASTA_VEREDITO=ENTRADA. Degrada rapido."
goto :q3
:p_tsext
set "PASTA_NOME=Implastec TS Extreme"
set "PASTA_DUR=Alta (36 meses)"
set "PASTA_VEREDITO=ENTUSIASTA. Alta performance."
goto :q3
:p_tscold
set "PASTA_NOME=Implastec TS Cold"
set "PASTA_DUR=Media"
set "PASTA_VEREDITO=INTERMEDIARIA."
goto :q3
:p_tspro
set "PASTA_NOME=Implastec TS Pro"
set "PASTA_DUR=Media"
set "PASTA_VEREDITO=ENTRADA."
goto :q3
:p_nmax
set "PASTA_NOME=PCYes Nitrogen Max"
set "PASTA_DUR=Alta"
set "PASTA_VEREDITO=ENTUSIASTA."
goto :q3
:p_npro
set "PASTA_NOME=PCYes Nitrogen Pro"
set "PASTA_DUR=Alta"
set "PASTA_VEREDITO=INTERMEDIARIA."
goto :q3
:p_nbasic
set "PASTA_NOME=PCYes Nitrogen Basic"
set "PASTA_DUR=Media"
set "PASTA_VEREDITO=ENTRADA."
goto :q3
:p_tf7
set "PASTA_NOME=Thermalright TF7"
set "PASTA_DUR=Baixa/Media"
set "PASTA_VEREDITO=Alta condutividade, durabilidade baixa."
goto :q3
:p_tfx
set "PASTA_NOME=Thermalright TFX"
set "PASTA_DUR=Media"
set "PASTA_VEREDITO=ENTUSIASTA."
goto :q3
:p_mx4
set "PASTA_NOME=Arctic MX-4"
set "PASTA_DUR=Muito Alta (8+ anos)"
set "PASTA_VEREDITO=EXCELENTE. Melhor durabilidade."
goto :q3
:p_mx6
set "PASTA_NOME=Arctic MX-6"
set "PASTA_DUR=Alta (5+ anos)"
set "PASTA_VEREDITO=EXCELENTE."
goto :q3
:p_nth1
set "PASTA_NOME=Noctua NT-H1"
set "PASTA_DUR=Alta (5 anos)"
set "PASTA_VEREDITO=EXCELENTE."
goto :q3
:p_nth2
set "PASTA_NOME=Noctua NT-H2"
set "PASTA_DUR=Alta (5 anos)"
set "PASTA_VEREDITO=EXCELENTE."
goto :q3
:p_kryo
set "PASTA_NOME=Thermal Grizzly Kryonaut"
set "PASTA_DUR=Media (3 a 5 anos)"
set "PASTA_VEREDITO=ENTUSIASTA."
goto :q3
:p_hydro
set "PASTA_NOME=Thermal Grizzly Hydronaut"
set "PASTA_DUR=Media (4 a 6 anos)"
set "PASTA_VEREDITO=ENTUSIASTA."
goto :q3
:p_auth
set "PASTA_NOME=Authentic Silver Thermal Pro"
set "PASTA_DUR=Alta"
set "PASTA_VEREDITO=ENTUSIASTA nacional."
goto :q3
:p_frio
set "PASTA_NOME=Friosys Glacial"
set "PASTA_DUR=Media"
set "PASTA_VEREDITO=ENTUSIASTA nacional."
goto :q3
:p_snow
set "PASTA_NOME=Snowdog Husky"
set "PASTA_DUR=Media"
set "PASTA_VEREDITO=ENTUSIASTA nacional."
goto :q3
:p_stock
set "PASTA_NOME=Pasta stock"
set "PASTA_DUR=1 a 3 anos"
set "PASTA_VEREDITO=BASICA."
goto :q3
:p_nsei
set "PASTA_NOME=Nao informada"
set "PASTA_DUR=Desconhecida"
set "PASTA_VEREDITO=Sem dados."
...
:ac_hyper212
set "COOLER_TDP=150"
set "COOLER_VEREDITO=Air cooler intermediario (150W)."
goto :q7_idade
:ac_ak400
set "COOLER_TDP=220"
set "COOLER_VEREDITO=Air cooler intermediario (220W)."
goto :q7_idade
:ac_ak620
set "COOLER_TDP=260"
set "COOLER_VEREDITO=Air cooler entusiasta (260W)."
goto :q7_idade
:ac_pa120
set "COOLER_TDP=265"
set "COOLER_VEREDITO=Entusiasta (265W). Melhor custo-beneficio."
goto :q7_idade
:ac_d15
set "COOLER_TDP=250"
set "COOLER_VEREDITO=Topo de linha (250W)."
goto :q7_idade
:ac_gammaxx
set "COOLER_TDP=130"
set "COOLER_VEREDITO=Entrada (130W)."
...
:wc_tuf2
set "COOLER_FAMILIA=ASUS TUF Gaming LC II"
set "COOLER_VEREDITO=ASUS TUF LC II: AIO confiavel."
goto :wc_size
:wc_ryujin
set "COOLER_FAMILIA=ASUS ROG Ryujin III"
set "COOLER_VEREDITO=Topo de linha ASUS."
goto :wc_size
:wc_ryuo
set "COOLER_FAMILIA=ASUS ROG Ryuo III"
set "COOLER_VEREDITO=Entusiasta ASUS."
goto :wc_size
:wc_strix
set "COOLER_FAMILIA=ASUS ROG Strix LC"
set "COOLER_VEREDITO=Entusiasta ASUS."
goto :wc_size
:wc_prime
set "COOLER_FAMILIA=ASUS Prime LC"
set "COOLER_VEREDITO=Entrada ASUS."
goto :wc_size
:wc_kraken
set "COOLER_FAMILIA=NZXT Kraken"
set "COOLER_VEREDITO=NZXT premium."
goto :wc_size
:wc_corsair
set "COOLER_FAMILIA=Corsair Hydro"
set "COOLER_VEREDITO=Corsair classica."
goto :wc_size
:wc_deepcool
set "COOLER_FAMILIA=DeepCool"
set "COOLER_VEREDITO=DeepCool: custo-beneficio."
goto :wc_size
:wc_arctic
set "COOLER_FAMILIA=Arctic Liquid Freezer II"
set "COOLER_VEREDITO=Arctic: melhor performance/ruido."
goto :wc_size
:wc_lianli
set "COOLER_FAMILIA=Lian Li Galahad II"
set "COOLER_VEREDITO=Lian Li: qualidade premium."
goto :wc_size
:wc_cm
set "COOLER_FAMILIA=Cooler Master ML"
set "COOLER_VEREDITO=Cooler Master: bom custo-beneficio."
goto :wc_size
:wc_rise
set "COOLER_FAMILIA=Rise Mode Aquarium"
set "COOLER_VEREDITO=Entrada nacional."
goto :wc_size
:wc_pcyes
set "COOLER_FAMILIA=PCYes Nix"
set "COOLER_VEREDITO=Entrada nacional."
goto :wc_size
:wc_generic
set "COOLER_FAMILIA=%COOLER_MODELO%"
set "COOLER_VEREDITO=Modelo nao reconhecido."
goto :wc_size
...
set "MONITOR_VEREDITO=[TOP] 1440p 500Hz QD-OLED. O mais rapido."
goto :analise_monitor
:mon_27gr95
...
if "%TIPO_JOGO%"=="Competitivo" set "REC_POL=[RECOMENDACAO] Para competitivos, 24\" ou 27\" e o ideal."
if "%TIPO_JOGO%"=="AAA Single-player" set "REC_POL=[RECOMENDACAO] Para AAA, 27\" 1440p ou 32\" 4K sao ideais."
if "%TIPO_JOGO%"=="Estrategia/Simulacao" set "REC_POL=[RECOMENDACAO] Para estrategia, 27\" 1440p ou 34\" Ultrawide."
if "%TIPO_JOGO%"=="Indie/Leves" set "REC_POL=[OK] Qualquer monitor de 24-27\" funciona bem."
if not defined REC_POL set "REC_POL=[RECOMENDACAO] Para uso misto, 27\" 1440p 180Hz e o ponto ideal."
...
if errorlevel 4 set "REC_SIMULADOR=[OUTROS] Para simuladores de veiculos, um volante com Force Feedback (Logitech G29/G920 - R$ 1.700-1.900) e a melhor escolha." & goto :escreve_log
...
echo RESULTADO FINAL: %PERCENT%% (%STATUS%) >> "%LOG%"
...
echo  ============================================================
echo.
echo    Pontuacao do Windows: %PERCENT%% (%STATUS%)
echo.
echo    HARDWARE:
...
echo    Sistema: %OSNAME%
echo.
echo    PERFIL: %PERFIL% ^| %PCT_ESC%% comercial, %PCT_JOG%% jogos
echo.
echo    MONITOR: %MONITOR_NOME%
echo    %SUGESTAO_MONITOR%
echo.
echo    RECOMENDACOES DE MANUTENCAO:
echo    %REC_LIMPEZA%
echo    %REC_PASTA%
echo    %REC_GABINETE%
echo    %REC_FONTE%
...
echo.
echo    PERIFERICOS:
echo    %REC_PERIF_MOUSE%
echo    %REC_PERIF_TECLADO%
echo    %REC_PERIF_HEADSET%
echo    %REC_PERIF_MOUSEPAD%
echo    %REC_CONTROLE%
echo.
echo    SIMULADORES:
echo    %REC_SIMULADOR%
...
echo    ------------------------------------------------------------
echo.
echo    AVISO: Precos estimados em Setembro de 2026.
echo    Valores podem mudar. Consulte antes de comprar.
echo.
echo    Powered by Alex Corcini
echo.
